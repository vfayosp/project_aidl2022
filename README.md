...
![Figure](https://latex.codecogs.com/png.image?IDCG(k)=\sum_{i=1}^{|I(k)|}\frac{G_i}{log_2(i+1)})

<img src="https://render.githubusercontent.com/render/math?math=IDCG(k)=\sum_{i=1}^{|I(k)|}\frac{G_i}{log_2(i+1)}#gh-light-mode-only">
